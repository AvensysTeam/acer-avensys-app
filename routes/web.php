...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth', 'check.session']], function () {
    ...
    //save notifier setting
    Route::get('notifiers','NotifierController@index')->name('notifier');
    Route::get('notifiers/{id}/edit','NotifierController@edit')->name('notifier.edit');
    Route::put('notifiers/{id}/','NotifierController@update')->name('notifier.update');
    Route::post('notifiers/','NotifierController@store')->name('notifier.store');
    Route::delete('notifiers/{id}','NotifierController@destroy')->name('notifier.destroy');

    Route::post('monitoring','MonitoringController@store')->name('monitoring.store');
    // Scooterstatuses
