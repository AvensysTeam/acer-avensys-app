...
<div id="sidebar" class="sidebar-menu transform -translate-x-full ease-in">
    ...
    <nav class="mt-4">
        ...
        @can('settings_access')
            <div class="nav-dropdown">
                <a class="nav-link border-white{{ request()->is('admin/settings/*') || request()->is('admin/notifiers*')  ? ' active' : '' }}" href="#">
                ...
                <div class="dropdown-items mb-1 hidden">
                    <a class="nav-link {{ request()->is('admin/settings/*') ? ' active' : '' }}" href="{{ route('admin.settings') }}">
                        <i class="fa-fw fas fa-tree"></i>
                        <span class="mx-4">@lang('APP Settings')</span>
                    </a>
                    <a class="nav-link {{ request()->is('admin/notifiers*') ? ' active' : '' }}" href="{{ route('admin.notifier') }}">
                        <i class="fa-fw fas fa-list"></i>
                        <span class="mx-4">@lang('Notifier List')</span>
                    </a>
                </div>
            </div>
        @endcan
